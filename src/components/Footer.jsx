    ...
    >
      ...
      <div className='flex justify-between py-4'>
        <div>
          ...
          <br /> <NavLink to={"/faqs"}>FAQs</NavLink>
        </div>
        <div>
        ...
        <div>
          ...
          <br />
          <NavLink to={"/affliate"}>Affiliate program</NavLink>
          <br />
        </div>
        <div>
          <strong>More from Dutiful</strong>
          <br />
          <br />
          <NavLink to={"/jobs"}>Dutiful jobs</NavLink>
        </div>
      </div>
      ...
      <div className='flex py-4 gap-16'>
        <div className='font-bold'>&copy; 2022 Dutiful&copy;</div>
